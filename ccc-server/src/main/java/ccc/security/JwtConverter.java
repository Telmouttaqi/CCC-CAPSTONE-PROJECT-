...
public class JwtConverter {
    ...
    private final String ISSUER = "schema_test"; // Not sure exactly what address the issuer has yet, but probably not this!  :)
                                                // I think it's: culture_connection_calendar.
