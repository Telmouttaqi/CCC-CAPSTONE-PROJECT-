...
import ccc.data.mappers.AppUserMapper;
...
public class AppUserJdbcTemplateRepository implements AppUserRepository {
    ...
    @Override
    @Transactional
    public AppUser create(AppUser user, int userId) {

        final String sql = "insert into app_user (username, password_hash, user_id) values (?, ?, ?);";
